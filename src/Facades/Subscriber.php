 ...
 * @method static void onCompletion(callable $handler)
 * @method static void onUnsubscribeFromMailingList(callable $handler)
 * @method static void onUnsubscribeFromAllMailingLists(callable $handler)
